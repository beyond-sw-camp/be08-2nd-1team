...
@Getter
@Setter
@Schema(description = "채팅/문의사항 내용 응답 데이터 전송 객체")
public class ChatContentResponseDto {
    ...
    @Schema(description = "채팅/문의사항을 보낸 사용자 ID", example = "1")
    private Long userId;

    @Schema(description = "채팅 내용과 관련된 채팅 목록 ID", example = "1")
    private Long chatId;

    @Schema(description = "문의사항 내용과 관련된 문의사항 목록 ID", example = "1")
