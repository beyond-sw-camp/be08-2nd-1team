package com.beyond.kkwoborrow.rental.entity.controller;

import com.beyond.kkwoborrow.rental.entity.dto.RentalResponseDto;
import com.beyond.kkwoborrow.rental.entity.service.RentalService;
...
public class RentalController {
    ...
    // 대여 신청 가능 물품 불러오기
    @GetMapping("/rental/{isReturn}")
    @Operation(summary = "대여 신청", description = "대여 가능한 물품의 목록을 조회한다.")
    public ResponseEntity<RentalResponseDto> Rent(@PathVariable("isReturn") boolean isReturn) {
